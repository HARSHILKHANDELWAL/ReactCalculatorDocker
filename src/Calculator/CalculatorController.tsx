...
import { functionBttns, numericalBttns, operationalBttns } from './CalculatorModel';
...
export default class CalculatorController extends React.Component<ICalculatorControllerProps, state> {
    ...
    numButtonClickHandler = (button:any) => {
        ...
        console.log("numButtonClickHandler")
        console.log("numButton25thClickHandler")
            ...
            {this.state.logout && (
              <Navigate to="/" replace={true} />
                ...
                <div className='operationBtn'>
                    <OperationController buttons={operationalBttns} onClick={this.operationButtonClickHandler} />
                </div>

                {/* function */}
                <div className='funBtn'>
                    {/* <FunctionController buttons={this.functionButtons} /> */}
                    <Function buttons={this.functionButtons} onClick={this.funButtonClickHandler} />
                </div>

                {/* number */}
                <div className='numButton'>
                    <NumberController buttons={numericalBttns} onClick={this.numButtonClickHandler} />
